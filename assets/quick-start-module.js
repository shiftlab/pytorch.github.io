...
function commandMessage(key) {
  var object = {
    ...
    "stable,libtorch,windows,cudanone,cplusplus":
      "Windows binaries do not support Java. Support is only available for Linux. Download here (Release version): <br/><a href='https://download.pytorch.org/libtorch/cpu/libtorch-win-shared-with-deps-1.3.1.zip'>https://download.pytorch.org/libtorch/cpu/libtorch-win-shared-with-deps-1.3.1.zip</a><br/><br> Download here (Debug version): <br/><a href='https://download.pytorch.org/libtorch/cpu/libtorch-win-shared-with-deps-debug-1.3.1.zip'>https://download.pytorch.org/libtorch/cpu/libtorch-win-shared-with-deps-debug-1.3.1.zip</a>",

    "stable,libtorch,windows,cuda9.2,cplusplus":
      "Windows binaries do not support Java. Support is only available for Linux. Download here (Release version): <br/><a href='https://download.pytorch.org/libtorch/cu92/libtorch-win-shared-with-deps-1.3.1.zip'>https://download.pytorch.org/libtorch/cu92/libtorch-win-shared-with-deps-1.3.1.zip</a><br/><br> Download here (Debug version): <br/><a href='https://download.pytorch.org/libtorch/cu92/libtorch-win-shared-with-deps-debug-1.3.1.zip'>https://download.pytorch.org/libtorch/cu92/libtorch-win-shared-with-deps-debug-1.3.1.zip</a>",

    "stable,libtorch,windows,cuda10.1,cplusplus":
      "Windows binaries do not support Java. Support is only available for Linux. Download here (Release version): <br/><a href='https://download.pytorch.org/libtorch/cu101/libtorch-win-shared-with-deps-1.3.1.zip'>https://download.pytorch.org/libtorch/cu101/libtorch-win-shared-with-deps-1.3.1.zip</a><br/><br> Download here (Debug version): <br/><a href='https://download.pytorch.org/libtorch/cu101/libtorch-win-shared-with-deps-debug-1.3.1.zip'>https://download.pytorch.org/libtorch/cu101/libtorch-win-shared-with-deps-debug-1.3.1.zip'/a>",
